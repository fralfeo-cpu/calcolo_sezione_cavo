...
function generatePVResultHTML(result) {
    ...
    if (archText) {
        ...
        configLine.innerHTML = `<strong>Configurazione:</strong> ${result.inputs.nStringhe} Stringa/e in parallelo per MPPT`;
                ...
                <div class="mppt-row">
                    ...
                    <div class="mppt-details">
                        <div class="mppt-main-line">
                            <span class="mppt-text">${sEff} stringa/e in parallelo da <strong>${cfg.moduli}</strong> moduli</span>
    ...
    try {
        ...
        const drawSegs = (doc, segs, startX, startY, size) => {
            ...
            segs.forEach(s => {
                ...
                // Further increased subscript offset for better clearance with descenders
                const sY = s.isSub ? startY + 3.2 : startY;
        ...
        if (proj.data.type === 'pv') {
            ...
            const mpptRows = d.mpptConfig.map(cfg => [
                `MPPT ${cfg.mppt}`,
                `${cfg.stringhe || d.inputs.nStringhe} Stringa/e`,
                `${cfg.moduli} Moduli`,
            ...
            d.mpptConfig.forEach((cfg, idx) => {
                ...
                doc.autoTable({
                    ...
                    body: [
                        ['Configurazione Canale', `${cfg.stringhe || d.inputs.nStringhe} stringhe in parallelo`],
            ...
            const sections = [
                ...
                {
                    title: "2. Verifica delle Tensioni di Stringa",
                ...
                {
                    title: "3. Protezione contro le Sovracorrenti (Fusibili Lato CC)",
                ...
                {
                    title: "4. Protezione contro le Sovratensioni (SPD Lato CC)",
